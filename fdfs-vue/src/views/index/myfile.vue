<template>
   <div class='root'>
      ...
      <cf v-on:getpage="getFiles" :navigat="navigatepageNums" :pages="pages" :filedata="filedata" :loading="loading" :pagesize="pagesize" :currentPage="currentPage" :total="total"></cf>
      ...
      searchFile(text, radio) {
               ...
               //  console.log(data)
                get({url: "/addres/search", params: data})
                    ...
                    this.loading = false;
                    this.$message.error({message: "搜索文件异常", duration: 800})
